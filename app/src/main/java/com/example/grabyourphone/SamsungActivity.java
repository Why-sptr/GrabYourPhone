...
public class SamsungActivity extends AppCompatActivity {
    ...
    private void getData(){
        AndroidNetworking.get("https://api-mobilespecs.azharimm.site/v2/brands/samsung-phones-9?page=1")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            DataAdapter myMovieAdapter = new DataAdapter(modelData,SamsungActivity.this);
